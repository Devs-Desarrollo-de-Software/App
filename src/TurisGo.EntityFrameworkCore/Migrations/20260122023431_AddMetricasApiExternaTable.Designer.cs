...
namespace TurisGo.Migrations
{
    ...
    [Migration("20260122023431_AddMetricasApiExternaTable")]
    partial class AddMetricasApiExternaTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurisGo.Calificaciones.Calificacion", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TurisGo.Eventos.Evento", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EventoIdExterno")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("Categoria")
                        .HasDatabaseName("IX_Eventos_Categoria");

                    b.HasIndex("Ciudad")
                        .HasDatabaseName("IX_Eventos_Ciudad");

                    b.HasIndex("DestinoId")
                        .HasDatabaseName("IX_Eventos_DestinoId");

                    b.HasIndex("EventoIdExterno")
                        .IsUnique()
                        .HasDatabaseName("IX_Eventos_EventoIdExterno");
            ...
            modelBuilder.Entity("TurisGo.Experiencias.Experiencia", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurisGo.Favoritos.Favorito", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TurisGo.Notificaciones.Notificacion", b =>
                {
                    ...
                    b.Property<bool>("EnviadaPorMail")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("TurisGo.Favoritos.Favorito", b =>
                {
                    b.HasOne("TurisGo.Destinos.Destino", "Destino")
                        .WithMany()
                        .HasForeignKey("DestinoId")
            ...
            modelBuilder.Entity("TurisGo.Usuarios.Usuario", b =>
                {
                    ...
                    b.OwnsOne("TurisGo.Usuarios.PreferenciasNotificacion", "Preferencias", b1 =>
                        {
                            b1.Property<Guid>("UsuarioId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("Frecuencia")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .HasDefaultValue(0)
                                .HasColumnName("Frecuencia");

                            b1.Property<bool>("RecibirEnPantalla")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bit")
                                .HasDefaultValue(true)
                                .HasColumnName("RecibirEnPantalla");

                            b1.Property<bool>("RecibirPorEmail")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bit")
                                .HasDefaultValue(false)
